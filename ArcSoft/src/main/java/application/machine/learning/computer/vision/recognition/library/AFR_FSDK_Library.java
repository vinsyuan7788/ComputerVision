...
public interface AFR_FSDK_Library extends Library {
	...
	AFR_FSDK_Library INSTANCE = (AFR_FSDK_Library) LoadUtils.loadLibrary(Platform.isWindows() ? "libarcsoft_fsdk_face_recognition.dll" : "libarcsoft_fsdk_face_recognition.so", AFR_FSDK_Library.class);
